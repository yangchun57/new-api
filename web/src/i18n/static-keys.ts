...
export const STATIC_I18N_KEYS = [
  ...
  'Distribution group updated successfully',
  'Distribution group deleted successfully',
  'Distribution group assigned successfully',
  'Distribution user frozen successfully',
  'Distribution user unfrozen successfully',
  'Distribution commission deducted successfully',
  'All distribution commissions deducted successfully',
  'Failed to load distribution groups',
  'Failed to load distribution ledgers',
  'Failed to create distribution group',
  'Failed to update distribution group',
  'Failed to delete distribution group',
  'Failed to assign distribution group',
  'Failed to update distribution freeze status',
  'Failed to deduct distribution commission',
  'Failed to deduct all distribution commissions',
] as const
